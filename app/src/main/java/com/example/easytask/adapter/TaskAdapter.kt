package com.example.easytask.adapter
...
import com.example.easytask.databinding.TaskLayoutBinding
import com.example.easytask.fragment.HomeFragmentDirections
...
class TaskAdapter: RecyclerView.Adapter<TaskAdapter.TaskViewHolder>() {
    ...
    override fun onBindViewHolder(holder: TaskViewHolder, position: Int) {
       val currentTask = differ.currentList[position]
        ...
        holder.itemBinding.NotePriority.text = currentTask.taskPriority
        holder.itemBinding.NoteDeadline.text = currentTask.taskDeadline
